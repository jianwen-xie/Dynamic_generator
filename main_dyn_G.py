...
tf.flags.DEFINE_string('ckpt_name', 'model.ckpt-2960')
...
def main():
    with tf.Session() as sess:
        ...
        if CONFIG.isTraining:
            ...
            model.test(ckpt_path, info_path, motion_path, is_random_content=True, is_random_motion_type=True, is_random_state_initial=False)
